...
file = open("E:\\Training\\Python\\Codding\\File_ Handling in pyhotn\\my_file_1.txt","w")        #it Will open a file if not exists it create or overwrite 
                                                                            # and open it for writing
if file:
    print("file create successfully")
    
try:
    file2 = open(r"E:\\Training\\Python\\Codding\\File_ Handling in pyhotn\\my_file.txt","r")       #It will raise an error because the no file 
...
try:
    file3 = open(r"E:\\Training\\Python\\Codding\\File_ Handling in pyhotn\\my_file.txt","a")      #It will not raise an error because the file will be created by mode "a"
